...
#    endif
#endif
    return ((std::uint32_t)buf[3] << 24) | ((std::uint32_t)buf[2] << 16) |
           ((std::uint32_t)buf[1] << 8) | ((std::uint32_t)buf[0]);
}
...
#    endif
#endif
    return ((std::uint64_t)buf[5] << 40) | ((std::uint64_t)buf[4] << 32) |
           ((std::uint64_t)buf[3] << 24) | ((std::uint64_t)buf[2] << 16) |
...
#    endif
#endif
    return ((std::uint64_t)buf[7] << 56) | ((std::uint64_t)buf[6] << 48) |
           ((std::uint64_t)buf[5] << 40) | ((std::uint64_t)buf[4] << 32) |
           ((std::uint64_t)buf[3] << 24) | ((std::uint64_t)buf[2] << 16) |
           ((std::uint64_t)buf[1] << 8) | ((std::uint64_t)buf[0]);
}
 ...
 * \return The deserialized data
 */
inline std::uint16_t GET_UINT16(
 ...
 * \return The deserialized data
 */
inline std::uint32_t GET_UINT32(
    const std::uint8_t* buf, const std::size_t offset)
{
 ...
 * \return The deserialized data
 */
inline std::uint64_t GET_UINT48(
    const std::uint8_t* buf, const std::size_t offset)
{
 ...
 * \param val Value to serialize
 */
inline void SET_UINT8(
    std::uint8_t* buf, const std::size_t offset, const std::uint8_t val)
{
 ...
 * \param val Value to serialize
 */
inline void SET_UINT16(
    std::uint8_t* buf, const std::size_t offset, const std::uint16_t val)
{
 ...
 * \param val Value to serialize
 */
inline void SET_UINT32(
    std::uint8_t* buf, const std::size_t offset, const std::uint32_t val)
{
 ...
 * \note For convenience the std::uint48 is stored into a std::uint64_t
 */
inline void SET_UINT48(
    std::uint8_t* buf, const std::size_t offset, const std::uint64_t val)
{
 ...
 * \param val Value to serialize
 */
inline void SET_INT8(
    std::uint8_t* buf, const std::size_t offset, const int8_t val)
{
 ...
 * \param val Value to serialize
 */
inline void SET_INT16(
    std::uint8_t* buf, const std::size_t offset, const int16_t val)
{
 ...
 * \param val Value to serialize
 */
inline void SET_INT32(
    std::uint8_t* buf, const std::size_t offset, const int32_t val)
{
 ...
 * \note For convenience the int48 is stored into a int64_t
 */
inline void SET_INT48(
    std::uint8_t* buf, const std::size_t offset, const int64_t val)
{
 ...
 * \param val Value to serialize
 */
inline void SET_FLOAT32(
    std::uint8_t* buf, const std::size_t offset, const float val)
{
 ...
 * \param val Value to serialize
 */
inline void SET_FLOAT64(
    std::uint8_t* buf, const std::size_t offset, const double val)
{
 ...
 * \param val Value to serialize
 */
inline void SET_UINT8(std::uint8_t* buf, const std::size_t offset,
    const std::uint8_t val, std::size_t& length)
{
    SET_UINT8(buf, offset, val);
    length += UINT8_SIZE;
}
 ...
 * \param val Value to serialize
 */
inline void SET_UINT16(std::uint8_t* buf, const std::size_t offset,
    const std::uint16_t val, std::size_t& length)
{
    SET_UINT16(buf, offset, val);
    length += UINT16_SIZE;
}
 ...
 * \param val Value to serialize
 */
inline void SET_UINT32(std::uint8_t* buf, const std::size_t offset,
    const std::uint32_t val, std::size_t& length)
{
    SET_UINT32(buf, offset, val);
    length += UINT32_SIZE;
}
 ...
 * \param val Value to serialize
 */
inline void SET_UINT48(std::uint8_t* buf, const std::size_t offset,
    const std::uint64_t val, std::size_t& length)
{
    SET_UINT48(buf, offset, val);
    length += UINT48_SIZE;
}
 ...
 * \param val Value to serialize
 */
inline void SET_UINT64(std::uint8_t* buf, const std::size_t offset,
    const std::uint64_t val, std::size_t& length)
{
    SET_UINT64(buf, offset, val);
    length += UINT64_SIZE;
 ...
 * \param val Value to serialize
 */
inline void SET_INT8(std::uint8_t* buf, const std::size_t offset,
    const int8_t val, std::size_t& length)
{
    SET_INT8(buf, offset, val);
    length += INT8_SIZE;
}
 ...
 * \param val Value to serialize
 */
inline void SET_INT16(std::uint8_t* buf, const std::size_t offset,
    const int16_t val, std::size_t& length)
{
    SET_INT16(buf, offset, val);
    length += INT16_SIZE;
}
 ...
 * \param val Value to serialize
 */
inline void SET_INT32(std::uint8_t* buf, const std::size_t offset,
    const int32_t val, std::size_t& length)
{
    SET_INT32(buf, offset, val);
    length += INT32_SIZE;
}
 ...
 * \param val Value to serialize
 */
inline void SET_INT48(std::uint8_t* buf, const std::size_t offset,
    const int64_t val, std::size_t& length)
{
    SET_INT48(buf, offset, val);
    length += INT48_SIZE;
}
 ...
 * \param val Value to serialize
 */
inline void SET_INT64(std::uint8_t* buf, const std::size_t offset,
    const int64_t val, std::size_t& length)
{
    SET_INT64(buf, offset, val);
    length += INT64_SIZE;
 ...
 * \param val Value to serialize
 */
inline void SET_FLOAT32(std::uint8_t* buf, const std::size_t offset,
    const float val, std::size_t& length)
{
    SET_FLOAT32(buf, offset, val);
    length += UINT32_SIZE;
}
 ...
 * \param val Value to serialize
 */
inline void SET_FLOAT64(std::uint8_t* buf, const std::size_t offset,
    const double val, std::size_t& length)
{
    SET_FLOAT64(buf, offset, val);
    length += UINT64_SIZE;
}
 ...
 */
inline void MEMCPY_UINT16(
    std::uint16_t* dest, const std::uint8_t* src, const std::size_t count)
{
#ifdef ENDN_IS_BIG_ENDIAN
 ...
 */
inline void MEMCPY_UINT32(
    std::uint32_t* dest, const std::uint8_t* src, const std::size_t count)
{
#ifdef ENDN_IS_BIG_ENDIAN
 ...
 */
inline void MEMCPY_UINT64(
    std::uint64_t* dest, const std::uint8_t* src, const std::size_t count)
{
#ifdef ENDN_IS_BIG_ENDIAN
 ...
 */
inline void SET_UINT8(
    char* buf, const std::size_t offset, const std::uint8_t val)
{
    SET_UINT8(&buf[offset], val);
}
 ...
 */
inline void SET_UINT16(
    char* buf, const std::size_t offset, const std::uint16_t val)
{
    SET_UINT16(&buf[offset], val);
}
 ...
 */
inline void SET_UINT32(
    char* buf, const std::size_t offset, const std::uint32_t val)
{
    SET_UINT32(&buf[offset], val);
}
 ...
 */
inline void SET_UINT48(
    char* buf, const std::size_t offset, const std::uint64_t val)
{
    SET_UINT48(&buf[offset], val);
}
 ...
 * \param val Value to serialize
 */
inline void SET_UINT8(char* buf, const std::size_t offset,
    const std::uint8_t val, std::size_t& length)
{
    SET_UINT8(buf, offset, val);
    length += UINT8_SIZE;
 ...
 * \param val Value to serialize
 */
inline void SET_UINT16(char* buf, const std::size_t offset,
    const std::uint16_t val, std::size_t& length)
{
    SET_UINT16(buf, offset, val);
    length += UINT16_SIZE;
 ...
 * \param val Value to serialize
 */
inline void SET_UINT32(char* buf, const std::size_t offset,
    const std::uint32_t val, std::size_t& length)
{
    SET_UINT32(buf, offset, val);
    length += UINT32_SIZE;
 ...
 * \param val Value to serialize
 */
inline void SET_UINT48(char* buf, const std::size_t offset,
    const std::uint64_t val, std::size_t& length)
{
    SET_UINT48(buf, offset, val);
    length += UINT48_SIZE;
 ...
 * \param val Value to serialize
 */
inline void SET_UINT64(char* buf, const std::size_t offset,
    const std::uint64_t val, std::size_t& length)
{
    SET_UINT64(buf, offset, val);
    length += UINT64_SIZE;
 ...
 */
inline void SET_INT8(
    char* buf, const std::size_t offset, const int8_t val, std::size_t& length)
{
    SET_INT8(buf, offset, val);
    length += INT8_SIZE;
}
 ...
 */
inline void SET_INT16(
    char* buf, const std::size_t offset, const int16_t val, std::size_t& length)
{
    SET_INT16(buf, offset, val);
    length += INT16_SIZE;
}
 ...
 */
inline void SET_INT32(
    char* buf, const std::size_t offset, const int32_t val, std::size_t& length)
{
    SET_INT32(buf, offset, val);
    length += INT32_SIZE;
}
 ...
 */
inline void SET_INT48(
    char* buf, const std::size_t offset, const int64_t val, std::size_t& length)
{
    SET_INT48(buf, offset, val);
    length += INT48_SIZE;
}
 ...
 */
inline void SET_FLOAT32(
    char* buf, const std::size_t offset, const float val, std::size_t& length)
{
    SET_FLOAT32(buf, offset, val);
    length += UINT32_SIZE;
}
 ...
 */
inline void SET_FLOAT64(
    char* buf, const std::size_t offset, const double val, std::size_t& length)
{
    SET_FLOAT64(buf, offset, val);
    length += UINT64_SIZE;
}
